					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="<?php echo base_url();?>assets/profil/<?php echo $image;?>" alt="Joseph Doe" class="img-circle" data-lock-picture="<?php echo base_url();?>assets/images/!logged-user.jpg" />
							</figure>
						...
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									<li class="nav-active">
										<a href="<?php echo site_url('cindex/dashboard');?>?username=<?php echo $username;?>">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="<?php echo site_url('cinv/inventory_pc');?>?username=<?php echo $username;?>">
													 Inventory PC
												</a>
											</li>
											<li>
