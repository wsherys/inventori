...
<html class="fixed">
	...
	<body>
							...
							<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
								...
								<tbody>
									...
									<tr class="gradeX">
										...
										<td>
											<a href="<?php echo site_url('crudinventory/page_edit');?>/?id=<?php echo $value2->id; ?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
											&nbsp;
											<a href="<?php echo site_url('crudinventory/page_delete');?>/?kode_pc=<?php echo $value2->kode_pc; ?>" class="on-default remove-row"><i class="fa fa-trash-o"></i></a></td>
									</tr>
									<?php } ?>
		...
		$.ajax({
		type    : 'post',
		url     : '<?php echo site_url('crudinventory/select_del'); ?>',
		data    : {'data' : dataArr},
		success : function(response){
		alert(response);
		window.location.href = '<?php echo site_url('cinv/inventory_pc'); ?>'; 
		},
